                    ...
                    <div id="sidebar"
                        ...
                        <table style="background-color:#f1f1f1;" width="238" cellspacing="0" cellpadding="5" border="0">
                            <tbody>
                                ...
                                <tr height="35">
                                    <td class="side-link {{ Route::current()->getName() == 'patient' ? 'active' : '' }} "
                                        id="age.phptd" onmouseover="changebg('age.php','on','patient');"
                                        onmouseout="changebg('age.php','off','patient')" align="center">
                                        <a href="{{ route('patient') }}" style="color:white;text-decoration:none;">
                                ...
                                <tr height="35">
                                    <td class="side-link {{ Route::current()->getName() == 'newpatient' ? 'active' : '' }} "
                                        id="patient.phptd" align="center"><b><a href="{{ route('newpatient') }}"
                                                                            ...
                                                                            <table class="no-print">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center"><a
                                                                                                href="javascript:newencountersubmit();">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr height="25" bgcolor="{{$index % 2? '#FFFFFF':'#d2d2d0'}}" id="patientRow{{$record->id}}">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr height="20">
                                                                                                        ...
                                                                                                        <td style="padding-top:0px;padding-bottom:0px;" width="25">
                                                                                                            <img src="{{ asset('images/spacer.png') }}" width="20" height="20">
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        ...
                                                                                        <td width="49%" align="left">
                                                                                            <img src="{{ asset('images/spacer.png') }}" id="billingimg0" width="15" height="15">
                                                                                        </td>
