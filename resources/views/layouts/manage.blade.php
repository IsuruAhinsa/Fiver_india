                        ...
                        <table style="background-color:#f1f1f1;" width="238" cellspacing="0" cellpadding="5" border="0">
                            <tbody>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td valign="top" align="center"><a
                                                            ...
                                                            href="javascript:printsubmit();">PRINT</a></td>
                                ...
                                <tr>
                                    ...
                                    <tr height="35">
      <td class="tdbg1" background ="{{ asset('nlimages/navbg.png')}}"style="background-repeat:no-repeat;background-position:center;" align="center"><a href="{{ route('soap', $data->id) }}" style="color:white;text-decoration:none;">
