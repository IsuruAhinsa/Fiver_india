...
@section('content')
    <form name="encform" enctype="multipart/form-data" action="{{ route('patientinfo', $data->id) }}" method="post">
        @csrf
        <script>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                @if ($data->patientphoto != null)
                                                                    <img src="{!!  asset('patientphotos/' . $data->patientphoto) !!}"
                                                                        height="100">
                                                            </td>
                                                            <td valign="top">
                                                                <img src="{{ asset('/images/delete.png') }}"
                                                                    onclick="{{ URL::to('/deleteimage/' . $data->id) }}" style="cursor: pointer">
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    </tbody>
